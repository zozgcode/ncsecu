...
import { TashaCainTxData } from "../transactionData/TrxData";
import Link from "next/link";

export default function TashaCain() {
  const top7TxData = TashaCainTxData.slice(0, 100); // Fetching only the first five transactions
  const moreThanSeven = TashaCainTxData.length > 100;
